...
namespace LiventaTransfer.Infrastructure.Migrations
{
    ...
    [Migration("20260725185546_AlignContractorFieldsWithCustomer")]
    partial class AlignContractorFieldsWithCustomer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LiventaTransfer.Domain.Entities.Contractor", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("LiventaTransfer.Domain.Entities.Job", b =>
                {
                    ...
                    b.Property<TimeOnly?>("FlightTime")
            ...
            modelBuilder.Entity("LiventaTransfer.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("LiventaTransfer.Domain.Entities.RefreshToken", b =>
                {
                    b.HasOne("LiventaTransfer.Domain.Entities.User", "User")
                        .WithMany()
